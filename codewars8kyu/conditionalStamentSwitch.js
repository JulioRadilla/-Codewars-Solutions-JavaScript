...
function howManydays(month){
    let days;
    switch (month){
        //case is basically saying if month == 1 and then under the case just write what you want to be executed so in this case we are letting it 
        //know to make our days variable to 31 and then use break to stop the  switch case to keep going
        case 1: 
          days=31;
          break;
        case 2: 
